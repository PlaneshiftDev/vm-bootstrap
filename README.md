...
prints pairing codes (LAN, plus Tailscale when it's running; desktop and mobile each), makes
omp available from any directory, points it at SearXNG, and leaves a note for coding agents. Optional extras — DiscordChatExporter
